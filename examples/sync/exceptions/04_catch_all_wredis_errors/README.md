# 04 Catch All WRedis Errors

## Description

Demonstrates catching all WRedis exceptions with a single WRedisError block, useful when the same handling applies to all error types.
